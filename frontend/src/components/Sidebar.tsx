        ...
        <div className="flex flex-col h-full">
          ...
          <div className="px-4 py-4 border-t border-gray-200">
            <button
              ...
              className="flex items-center w-full px-4 py-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-red-50 hover:text-red-700 transition-colors duration-150"
            >
              <svg
